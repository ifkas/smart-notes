        ...
        <div class="logo">
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                ...
                <path style="fill:#231F20;" d="M298.586,136.76h8.517v-17.034h-8.517c-4.701,0-8.517-3.816-8.517-8.517V94.174h-17.034v17.034
                    ...
                    <rect x="256.017" y="149.843" transform="matrix(-0.4999 0.8661 -0.8661 -0.4999 592.9402 110.6147)" style="fill:#231F20;" width="17.035" height="153.311"/>

                    <rect x="230.482" y="196.408" transform="matrix(-0.5 0.866 -0.866 -0.5 594.9771 202.6153)" style="fill:#231F20;" width="17.034" height="153.305"/>

                    <rect x="204.9" y="242.903" transform="matrix(-0.5 0.866 -0.866 -0.5 596.8688 294.5133)" style="fill:#231F20;" width="17.034" height="153.305"/>
                </g>
            </svg>
        </div>
        <at-button @click.prevent="signInWithGoogle" icon="icon-user-plus" hollow>Login with Google</at-button>
    </div>
</template>
